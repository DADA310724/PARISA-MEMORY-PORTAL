...
export function Sidebar({ onClose }: SidebarProps) {
  ...
  return (
    <aside
      ...
      data-testid="sidebar"
      style={{
        background: "linear-gradient(180deg, rgba(1,14,22,0.98) 0%, rgba(0,9,16,0.99) 100%)",
        borderRight: "1px solid rgba(0,229,180,0.22)",
    ...
    >
      ...
      <div style={{ borderTop: "1px solid hsl(var(--primary) / 0.1)" }}>
        <div className="px-3 py-2 flex items-center justify-center overflow-hidden">
          ...
          >
            <p
              className="text-[10px] font-medium tracking-[0.15em] uppercase whitespace-nowrap"
            ...
            >
              <SiTelegram style={{ width: 14, height: 14, color: "rgba(33,186,252,0.9)" }} />
            </div>
          </a>
        </div>
