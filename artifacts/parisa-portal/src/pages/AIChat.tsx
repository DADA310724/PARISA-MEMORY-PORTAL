...
export default function AIChatPage() {
  ...
  async function callApiDirect(text: string, mode: "chat" | "audiocall" | "videocall" = "chat", imageData?: string): Promise<string> {
    const CALL_RULES = `
কঠোর নিয়মাবলী (অবশ্যই মানতে হবে):
১. শুধুমাত্র নিচে দেওয়া ইতিহাস, চ্যাট হিস্টরি ও ফোল্ডার তথ্য থেকে উত্তর দাও — কোনো তথ্য বানিয়ে বলবে না
২. যে তথ্য সিস্টেমে নেই সেটা সম্পর্কে বলো "এই বিষয়ে নির্দিষ্ট তথ্য পাওয়া যাচ্ছে না"
৩. চ্যাট হিস্টরি জিজ্ঞেস করলে — সিস্টেমে যা আছে হুবহু সেটাই বলো
৪. ড্যাশবোর্ডের ফোল্ডার জিজ্ঞেস করলে — নিচের ফোল্ডার তালিকা থেকে বিস্তারিত বলো (লক করা ফোল্ডার ছাড়া)
৫. "আমি AI", "ভার্চুয়াল সহকারী", "আমার শরীর নেই" — এই ধরনের কথা বলবে না
৬. ইমোজি বা মার্কডাউন ব্যবহার করবে না (TTS পড়বে)
৭. বাংলায় স্পষ্টভাবে উত্তর দাও — ছোট প্রশ্নে সংক্ষেপে, বড় প্রশ্নে বিস্তারিত
৮. কাউকে নাম ধরে চিনবে না বা সম্বোধন করবে না\n\n`;

    const callPrefix = mode === "videocall"
      ? `তুমি এখন সরাসরি ভিডিও কলে কথা বলছো। তোমার ক্যামেরা আছে — ছবি দেওয়া হলে সেটি দেখে বিস্তারিত বাংলায় বলো কী দেখা যাচ্ছে।\n${CALL_RULES}`
      : mode === "audiocall"
